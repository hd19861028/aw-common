 ...
 * @param {Function} callback	回调函数，包含2个参数：fields，files
 * @param {Object} save_as	表单文件默认存储路径，默认取global.config.upload_temp值
 */
 ...
 * 
 * @param {String} pwd	传入的密码
 * @return {Promise}		{ salt: xxx, pwd: xxx }
 */
