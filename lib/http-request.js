...
function _send(requrl, data, method, headers) {
	var d = q.defer();
	var params = '';
	if (data) {
 ...
 */
exports.Post = function(requrl, data, headers) {
	return _send(requrl, data, 'post', headers)
}
 ...
 * @return {Promise}	返回的内容
 */
exports.Put = function(requrl, data, headers) {
	return _send(requrl, data, 'put', headers)
}
 ...
 * @return {Promise}	返回的内容
 */
exports.Get = function(requrl, headers) {
	return _send(requrl, null, 'get', headers)
}
 ...
 * @return {Promise}	返回的内容
 */
exports.Delete = function(requrl, headers) {
	return _send(requrl, null, 'delete', headers)
}
